  ...
  const dragGesture = Gesture.Pan()
    ...
    .onEnd((e) => {
      if (e.translationY > CLOSE_THRESHOLD || e.velocityY > VELOCITY_THRESHOLD) {
        ...
        translateY.value = withSpring(0, { damping: 28, stiffness: 180, mass: 0.9 });
  ...
  return (
    <Modal visible={localVisible} transparent animationType="none" onRequestClose={onClose} onShow={openSheet}>
      ...
      <View style={styles.root}>
        ...
        <Animated.View style={[styles.sheetWrapper, wrapperStyle]} pointerEvents="box-none">
          <GestureDetector gesture={dragGesture}>
            ...
            >
              {/* Grab bar */}
              <Pressable hitSlop={{ top: 16, bottom: 16, left: 60, right: 60 }}>
